...
export class CETH__factory extends ContractFactory {
  ...
  override attach(address: string): CETH {
    return super.attach(address) as CETH;
  }
  override connect(signer: Signer): CETH__factory {
    return super.connect(signer) as CETH__factory;
  }
