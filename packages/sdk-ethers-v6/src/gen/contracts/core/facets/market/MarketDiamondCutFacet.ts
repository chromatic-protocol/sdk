...
export interface MarketDiamondCutFacetInterface extends Interface {
...
export interface MarketDiamondCutFacet extends BaseContract {
  connect(runner?: ContractRunner | null): MarketDiamondCutFacet;
  waitForDeployment(): Promise<this>;

  interface: MarketDiamondCutFacetInterface;
