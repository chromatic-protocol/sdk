...
export interface MarketLiquidityFacetBaseInterface extends Interface {
  getEvent(
...
export interface MarketLiquidityFacetBase extends BaseContract {
  connect(runner?: ContractRunner | null): MarketLiquidityFacetBase;
  waitForDeployment(): Promise<this>;

  interface: MarketLiquidityFacetBaseInterface;
