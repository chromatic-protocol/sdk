...
export interface ChromaticLiquidatorMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "automate"
...
export interface ChromaticLiquidatorMock extends BaseContract {
  connect(runner?: ContractRunner | null): ChromaticLiquidatorMock;
  waitForDeployment(): Promise<this>;

  interface: ChromaticLiquidatorMockInterface;
  ...
  "liquidate(address,uint256,uint256)": TypedContractMethod<
    [market: AddressLike, positionId: BigNumberish, fee: BigNumberish],
    [void],
    "nonpayable"
  >;
   ...
   * @param positionId The ID of the position to be liquidated.
   */
  "liquidate(address,uint256)": TypedContractMethod<
    [market: AddressLike, positionId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "liquidate(address,uint256,uint256)"
  ): TypedContractMethod<
    [market: AddressLike, positionId: BigNumberish, fee: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "liquidate(address,uint256)"
  ): TypedContractMethod<
    [market: AddressLike, positionId: BigNumberish],
    [void],
    "nonpayable"
