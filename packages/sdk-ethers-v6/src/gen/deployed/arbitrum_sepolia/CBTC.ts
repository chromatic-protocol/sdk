...
export interface CBTCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface CBTC extends BaseContract {
  connect(runner?: ContractRunner | null): CBTC;
  waitForDeployment(): Promise<this>;

  interface: CBTCInterface;
