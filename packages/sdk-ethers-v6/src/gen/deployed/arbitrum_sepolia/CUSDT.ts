...
export interface CUSDTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface CUSDT extends BaseContract {
  connect(runner?: ContractRunner | null): CUSDT;
  waitForDeployment(): Promise<this>;

  interface: CUSDTInterface;
