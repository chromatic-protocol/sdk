...
} from "../../../contracts/mocks/TestSettlementToken";
...
export class TestSettlementToken__factory {
  static readonly abi = _abi;
  static createInterface(): TestSettlementTokenInterface {
    return new Interface(_abi) as TestSettlementTokenInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as TestSettlementToken;
  }
}
