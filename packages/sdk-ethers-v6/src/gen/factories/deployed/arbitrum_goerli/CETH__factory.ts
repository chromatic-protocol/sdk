...
type CETHConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: CETHConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class CETH__factory extends ContractFactory {
  constructor(...args: CETHConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): CETH__factory {
    return super.connect(runner) as CETH__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CETHInterface {
    return new Interface(_abi) as CETHInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): CETH {
    return new Contract(address, _abi, runner) as unknown as CETH;
  }
}
