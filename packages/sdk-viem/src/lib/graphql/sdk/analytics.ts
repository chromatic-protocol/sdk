...
export type ClpDailyHistoriesQueryVariables = Exact<{
...
export type ClpDailyHistoriesQuery = { __typename?: 'query_root', lp_value_daily_histories: Array<{ __typename?: 'lp_value_daily_histories', clp_total_supply: any, date: string, holding_value: any, holding_clb_value: any, pending_clb_value: any, pending_value: any }> };

export type ClpHourlyHistoriesQueryVariables = Exact<{
  start: Scalars['numeric']['input'];
  end: Scalars['numeric']['input'];
  address: Scalars['citext']['input'];
}>;


export type ClpHourlyHistoriesQuery = { __typename?: 'query_root', lp_value_histories: Array<{ __typename?: 'lp_value_histories', clp_total_supply: any, block_timestamp: any, holding_value: any, holding_clb_value: any, pending_clb_value: any, pending_value: any }> };


export const ClpDailyHistoriesDocument = gql`
  ...
  lp_value_daily_histories(
    ...
    `;
export const ClpHourlyHistoriesDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ClpDailyHistories(variables: ClpDailyHistoriesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ClpDailyHistoriesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClpDailyHistoriesQuery>(ClpDailyHistoriesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ClpDailyHistories', 'query', variables);
    },
    ClpHourlyHistories(variables: ClpHourlyHistoriesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ClpHourlyHistoriesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClpHourlyHistoriesQuery>(ClpHourlyHistoriesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ClpHourlyHistories', 'query', variables);
    }
  };
}
