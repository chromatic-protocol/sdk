...
export type ChromaticMarketBinStatus = {
  ...
  totalBinValue: Scalars['BigInt']['output'];
  totalFreeLiquidity: Scalars['BigInt']['output'];
...
export type ChromaticMarketBinStatus_Filter = {
  ...
  totalBinValue?: InputMaybe<Scalars['BigInt']['input']>;
  totalBinValue_gt?: InputMaybe<Scalars['BigInt']['input']>;
  totalBinValue_gte?: InputMaybe<Scalars['BigInt']['input']>;
  totalBinValue_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  totalBinValue_lt?: InputMaybe<Scalars['BigInt']['input']>;
  totalBinValue_lte?: InputMaybe<Scalars['BigInt']['input']>;
  totalBinValue_not?: InputMaybe<Scalars['BigInt']['input']>;
  totalBinValue_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  totalFreeLiquidity?: InputMaybe<Scalars['BigInt']['input']>;
  totalFreeLiquidity_gt?: InputMaybe<Scalars['BigInt']['input']>;
  totalFreeLiquidity_gte?: InputMaybe<Scalars['BigInt']['input']>;
  totalFreeLiquidity_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  totalFreeLiquidity_lt?: InputMaybe<Scalars['BigInt']['input']>;
  totalFreeLiquidity_lte?: InputMaybe<Scalars['BigInt']['input']>;
  totalFreeLiquidity_not?: InputMaybe<Scalars['BigInt']['input']>;
  totalFreeLiquidity_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum ChromaticMarketBinStatus_OrderBy {
  ...
  Market = 'market',
  Statuses = 'statuses',
  TotalBinValue = 'totalBinValue',
  TotalFreeLiquidity = 'totalFreeLiquidity',
...
export enum LiquidityBinStatus_OrderBy {
  ...
  ParentTotalBinValue = '_parent__totalBinValue',
  ParentTotalFreeLiquidity = '_parent__totalFreeLiquidity',
  ParentTotalLiquidity = '_parent__totalLiquidity',
  BinValue = 'binValue',
